...
class Scribble():
    ...
    def unet_infer(self, noise, t, context, c):
        ...
        t_inp = cuda.DeviceView(ptr=t.data_ptr(), shape=t.shape, dtype=np.float32)
        context_inp = cuda.DeviceView(ptr=context.data_ptr(), shape=context.shape, dtype=np.float32)
        dbrs0_inp = cuda.DeviceView(ptr=c[0].data_ptr(), shape=c[0].shape, dtype=np.float32)
        dbrs1_inp = cuda.DeviceView(ptr=c[1].data_ptr(), shape=c[1].shape, dtype=np.float32)
        dbrs2_inp = cuda.DeviceView(ptr=c[2].data_ptr(), shape=c[2].shape, dtype=np.float32)
        dbrs3_inp = cuda.DeviceView(ptr=c[3].data_ptr(), shape=c[3].shape, dtype=np.float32)
        dbrs4_inp = cuda.DeviceView(ptr=c[4].data_ptr(), shape=c[4].shape, dtype=np.float32)
        dbrs5_inp = cuda.DeviceView(ptr=c[5].data_ptr(), shape=c[5].shape, dtype=np.float32)
        dbrs6_inp = cuda.DeviceView(ptr=c[6].data_ptr(), shape=c[6].shape, dtype=np.float32)
        dbrs7_inp = cuda.DeviceView(ptr=c[7].data_ptr(), shape=c[7].shape, dtype=np.float32)
        dbrs8_inp = cuda.DeviceView(ptr=c[8].data_ptr(), shape=c[8].shape, dtype=np.float32)
        dbrs9_inp = cuda.DeviceView(ptr=c[9].data_ptr(), shape=c[9].shape, dtype=np.float32)
        dbrs10_inp = cuda.DeviceView(ptr=c[10].data_ptr(), shape=c[10].shape, dtype=np.float32)
        dbrs11_inp = cuda.DeviceView(ptr=c[11].data_ptr(), shape=c[11].shape, dtype=np.float32)
        mbrs0_inp = cuda.DeviceView(ptr=c[12].data_ptr(), shape=c[12].shape, dtype=np.float32)
